...
all : $(TARGET_NAME)$(EXE_EXT) EXE.mak
...
MultiRobot.obj : MultiRobot.cpp MultiRobot.h    KitchenRobot.h ElectricMotor.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"MultiRobot.obj" "MultiRobot.cpp" 



ElectricMotor.obj : ElectricMotor.cpp ElectricMotor.h    KitchenRobot.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"ElectricMotor.obj" "ElectricMotor.cpp" 



KitchenRobotBuilder.obj : KitchenRobotBuilder.cpp KitchenRobotBuilder.h    KitchenRobot.h MultiRobot.h ElectricMotor.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"KitchenRobotBuilder.obj" "KitchenRobotBuilder.cpp" 



Cook.obj : Cook.cpp Cook.h    KitchenRobot.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Cook.obj" "Cook.cpp" 



Serviceman.obj : Serviceman.cpp Serviceman.h    KitchenRobot.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Serviceman.obj" "Serviceman.cpp" 



KitchenRobot.obj : KitchenRobot.cpp KitchenRobot.h    MultiRobot.h ElectricMotor.h KitchenRobotBuilder.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"KitchenRobot.obj" "KitchenRobot.cpp" 
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) EXE.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) EXE.mak
	@echo Building library $@
	$(LIB_CMD) $(LIB_FLAGS) /out:$(TARGET_NAME)$(LIB_EXT) $(OBJS) $(ADDITIONAL_OBJS) $(LIBS)

clean:
	@echo Cleanup
	if exist MultiRobot.obj erase MultiRobot.obj
	if exist ElectricMotor.obj erase ElectricMotor.obj
	if exist KitchenRobotBuilder.obj erase KitchenRobotBuilder.obj
	if exist Cook.obj erase Cook.obj
	if exist Serviceman.obj erase Serviceman.obj
	if exist KitchenRobot.obj erase KitchenRobot.obj
